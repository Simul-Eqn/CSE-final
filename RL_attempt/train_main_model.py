chosen_mass_spec_gcn_path = './RL_attempt/mass_spec_lr_search_without_pooling/search_3e-07_3e-07/models/mass_spec_training/FTreeGCN_training_epoch_35.pt' 
...
non_anomalous_path.init(chosen_mass_spec_gcn_path, "", 85, 5, -0.0, 0.0005, -0.0, 0.95, True, 12)
...
non_anomalous_path.init(chosen_mass_spec_gcn_path, "", 85, 5, -0.0, 0.0005, -0.0, 0.95, False, 12)
...
non_anomalous_path.init(chosen_mass_spec_gcn_path, "", 85, 5, -0.0, 0.0005, -0.0, 0.95, False, 15)
