...
for gcn_lr in gcn_lrs: 
    for nu in nus: 
        ...
        plt.savefig(save_path+'/search_'+str(gcn_lr)+"_"+str(num_guesses_per_state)+"_moves_"+str(nu)+"_depth_success_valid.svg") 
        plt.show() 
        ...
        plt.savefig(save_path+'/search_'+str(gcn_lr)+"_"+str(num_guesses_per_state)+"_moves_"+str(nu)+"_depth_compare_success_valid.svg") 
        plt.show() 
        ...
        plt.legend(loc="upper right") 
        plt.savefig(save_path+'/search_'+str(gcn_lr)+"_"+str(num_guesses_per_state)+"_moves_"+str(nu)+"_depth_action_valid.svg") 
        plt.show() 
        ...
        plt.legend(loc="upper right", ncol=2, fontsize='x-small') 
        plt.savefig(save_path+'/search_'+str(gcn_lr)+"_"+str(num_guesses_per_state)+"_moves_"+str(nu)+"_depth_success_test.svg") 
        plt.show() 
        ...
        plt.legend(loc="upper right") 
        plt.savefig(save_path+'/search_'+str(gcn_lr)+"_"+str(num_guesses_per_state)+"_moves_"+str(nu)+"_depth_compare_success_test.svg") 
        plt.show() 
        ...
        plt.legend(loc="upper right") 
        plt.savefig(save_path+'/search_'+str(gcn_lr)+"_"+str(num_guesses_per_state)+"_moves_"+str(nu)+"_depth_action_test.svg") 
        plt.show() 
