...
save_path_prefix = './RL_attempt/figures/mass_spec_comparison/' 
...
plt.savefig(save_path_prefix+"train_loss.svg")
plt.show() 
...
# MAKE FIGURES OF MASS SPEC VISUALLY, looking at a selected mass spec GCN 
for get in ['train', 'test']: 
